(function () {
    var sessionTimeout = function (options) {
        ...
        dialogElement.innerHTML = '<p>' + o.message + '</p><p id="sessionTimeout-counter"></p>';
        ...
        function Dialog(element, options) {
            ...
            self.updateCounter = function () {
                var counterElement = self.element.querySelector('#sessionTimeout-counter');
                var remainingTime = Math.ceil((o.redirAfter - o.warnAfter) / 1000);
                counterElement.textContent = 'Remaining Time: ' + remainingTime + ' seconds';
            };
