(function (window, document) {
    ...
    sessionTimeout.initialize = function (options) {
      ...
      function startCounter(duration) {
        counterElement = modalContainer.querySelector('.session-timeout-counter');
        counterElement.textContent = formatTime(duration);
  
        var startTime = Date.now();
        counterInterval = setInterval(function () {
          var elapsed = Date.now() - startTime;
          var remaining = duration - elapsed;
          counterElement.textContent = formatTime(remaining);
